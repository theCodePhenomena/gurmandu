  ...
  return (
    ...
    >
      ...
      <span className='flex flex-col leading-tight'>
        ...
        <span className='mt-0.5 inline-flex items-center gap-1 text-[9px] font-medium opacity-90 sm:text-[10px]'>
          <ShoppingBagIcon className='size-2.5 shrink-0 sm:size-3' aria-hidden='true' /> {t('sticky.notice')}
        </span>
      </span>
    </a>
  )
